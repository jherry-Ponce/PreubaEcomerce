    ...
    <Container component="main" maxWidth="sm" className="vh-100 d-flex align-items-center">
      ...
      >
        ...
        <div className="d-flex w-100 justify-content-evenly mt-3">
          <NavLink to="/login" className="nav-link text-decoration-underline">Login</NavLink>
          <NavLink to="" className="nav-link active fw-bold text-decoration-underline">Register</NavLink>
        </div>
