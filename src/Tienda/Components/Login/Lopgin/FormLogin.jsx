    ...
    <Grid container component="main" sx={{ height: "100vh" }}>
      ...
      <Grid item xs={12} sm={8} md={4} component={Paper} elevation={6} square className={"d-flex align-items-center"}>
        ...
        >
          ...
          <NavLink to="" className="nav-link  active fw-bold text-decoration-underline">Login</NavLink>
          <NavLink to="/register" className="nav-link text-decoration-underline">Register</NavLink>
        </div>
